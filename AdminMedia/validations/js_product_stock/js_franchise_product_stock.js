...
$("#add_product").click(function(){
  ...
  htms += '</select></td>';
    ...
    htms += '<td><input type="text" class="form-control new_qty" name="" id="" placeholder="" value=""></td>';
  ...
  $(".product_cls").change(function(){
    ...
    $.ajax({
              url: $('#base_url').val() + 'franchise/stock_management/Cn_stock_management/get_franchise_product_quantity',
...
{
  var i=0, j=0, k=0, l=0, m=0, n=0, p=1;
